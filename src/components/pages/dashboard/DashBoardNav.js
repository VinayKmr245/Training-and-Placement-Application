        ...
        <div className={classes.dashBoardNav}>
          <div className={classes["nav-top"]}>
            ...
            <div className={classes["dashboard-nav-links"]}>
              ...
              <NavLink
                to={`/dashboard/analytics/${UserName}`}
                activeClassName={classes["active-link"]}
                onClick={hideSideNavHandler}
              >
                <div className={classes["nav-link"]}>
              ...
              <NavLink
                to={`/dashboard/companies/${UserName}`}
                activeClassName={classes["active-link"]}
                onClick={hideSideNavHandler}
              >
                <div className={classes["nav-link"]}>
              ...
              <NavLink
                to={`/dashboard/alumni/${UserName}`}
                activeClassName={classes["active-link"]}
                onClick={hideSideNavHandler}
              >
                <div className={classes["nav-link"]}>
                  <a href="/qwww">Alumni</a>
                </div>
              </NavLink>

              <NavLink
                to={`/dashboard/doubts/${UserName}`}
                activeClassName={classes["active-link"]}
                onClick={hideSideNavHandler}
              >
                <div className={classes["nav-link"]}>
                  <a href="/qwww">Doubts</a>
                </div>
              </NavLink>

              <NavLink
                to={`/dashboard/previous-year-questions/${UserName}`}
                activeClassName={classes["active-link"]}
                onClick={hideSideNavHandler}
              >
                <div className={classes["nav-link"]}>
                  <a href="/qwww">Previous Year Questions</a>
                </div>
              </NavLink>
            </div>
          </div>
